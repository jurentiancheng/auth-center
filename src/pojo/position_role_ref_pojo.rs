...
#[serde(rename_all = "camelCase")]
pub struct PositionRoleRefCondition {
    pub id: Option<i64>,
...
crate::impl_pageable!(PositionRoleRefCondition);

#[derive(Serialize, Deserialize, Debug, Clone, Default)]
#[serde(rename_all = "camelCase")]
pub struct PositionRoleRefDto {
...
crate::impl_into_json_value!(PositionRoleRefDto);
