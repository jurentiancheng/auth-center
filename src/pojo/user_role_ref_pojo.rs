...
#[serde(rename_all = "camelCase")]
pub struct UserRoleRefCondition {
    pub id: Option<i64>,
...
crate::impl_pageable!(UserRoleRefCondition);

#[derive(Serialize, Deserialize, Debug, Clone, Default)]
#[serde(rename_all = "camelCase")]
pub struct UserRoleRefDto {
...
crate::impl_into_json_value!(UserRoleRefDto);
