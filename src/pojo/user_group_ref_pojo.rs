...
#[serde(rename_all = "camelCase")]
pub struct UserGroupRefCondition {
    pub id: Option<i64>,
...
crate::impl_pageable!(UserGroupRefCondition);

#[derive(Serialize, Deserialize, Debug, Clone, Default)]
#[serde(rename_all = "camelCase")]
pub struct UserGroupRefDto {
...
crate::impl_into_json_value!(UserGroupRefDto);
